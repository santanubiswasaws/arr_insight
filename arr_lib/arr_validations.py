...
from arr_lib.column_mapping import PREDEFINED_DATE_FORMAT_MAP
...
def validate_input_data(df):
    ...
    if not all(col in df.columns for col in required_columns):
        raise ValueError("Columns 'customerId', 'contractId', 'contractStartDate', 'contractEndDate', 'totalContractValue', 'startDateFormat', and 'endDateFormat' are required columns")
        return False
